...
const Header = (props) => {
    ...
    const linkClasses = isLogged=='1' 
        ...
        : 'block py-2 px-3 text-gray-500 bg-gray-300 rounded cursor-not-allowed md:bg-transparent md:p-0';

    const linkClassesRev = isLogged=='1' 
        ? 'block py-2 px-3 text-gray-500 bg-gray-300 rounded cursor-not-allowed md:bg-transparent md:p-0'
        : 'block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:p-0' ;

    console.log(isLogged, linkClasses)
        ...
        <div className="flex flex-wrap justify-between p-4">
            ...
            <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                ...
                <li className="flex">
                    ...
                    <Link href="/history" className={linkClasses} aria-current="page">Historial</Link>
                </li>
                <li className="flex">
                    ...
                    <Link href="/login" className={linkClassesRev}>Iniciar sesión</Link>
                </li>
                <li className="flex">
                    ...
                    <Link href="register" className={linkClassesRev}>Registrarse</Link>
                </li>
                </ul>
            </div>
        </div>
        <div className="flex flex-wrap justify-between p-4">
            ...
            <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                ...
                <li className="flex">
                    ...
                    <Link href="/wishlist" className={linkClasses}>Lista de deseos</Link>
                </li>
                <li className="flex">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M7 22q-.825 0-1.412-.587T5 20t.588-1.412T7 18t1.413.588T9 20t-.587 1.413T7 22m10 0q-.825 0-1.412-.587T15 20t.588-1.412T17 18t1.413.588T19 20t-.587 1.413T17 22M6.15 6l2.4 5h7l2.75-5zM5.2 4h14.75q.575 0 .875.513t.025 1.037l-3.55 6.4q-.275.5-.737.775T15.55 13H8.1L7 15h11q.425 0 .713.288T19 16t-.288.713T18 17H7q-1.125 0-1.7-.987t-.05-1.963L6.6 11.6L3 4H2q-.425 0-.712-.288T1 3t.288-.712T2 2h1.625q.275 0 .525.15t.375.425zm3.35 7h7z"/></svg>
                    <Link href="cart" className={linkClasses}>Carrito</Link>
                </li>
                </ul>
            </div>
        </div>

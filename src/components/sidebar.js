...
const Sidebar = (props) => {
    ...
    return (
    <div id="drawer-navigation" class={`fixed top-30 left-0 z-40 w-64 h-screen p-4 overflow-y-auto transition-transform bg-white dark:bg-gray-800 ${props.isOpen ? '' : 'hidden'} ${props.isOpen ? 'translate-x-0' : '-translate-x-full'}`} 
        ...
        <div class="py-4 overflow-y-auto">
            <h3 id="cate" className="font-semibold text-xl my-2">Categorías</h3>
            ...
            <h3 className="font-semibold text-xl mb-2">Precio</h3>
            <ul class="space-y-2 font-medium">
                <li>

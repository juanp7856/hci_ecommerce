        ...
        <MainLayout title="SpyInv | Carrito" content="Página para poder ver tus items que vas a comprar">
            ...
            <section className="w-full">
                    ...
                    <tbody className="border">
                        {
                            productos.map((producto, i) => {
                                return <TarjetaCarrito producto={producto} id={i}/>
                            })
                        }
                    </tbody>
                </table>
                ...
                <div className="mx-auto w-1/2 text-center">
                    <button type="button" class="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-4 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">IR A PAGAR</button>
                </div>
            </section>
        </MainLayout>
    )

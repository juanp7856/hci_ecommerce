                                    ...
                                    <div className="ms-4 mb-8">
                                        ...
                                        <div className="grid-cols-3 grid">
                                            <div className="col-span-2">
                                                ...
                                                <input type="text" id="conta" class="w-9/12 bg-gray-50 border border-gray-300 w-2/3 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full block p-1.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
                                            </div>
                                            <div>
